...
local function layout()
  ...
  lcd.drawRectangle(x0, y0, HORIZON_WIDTH, HORIZON_HEIGHT, GREY_DEFAULT)
  -- left wing
  lcd.drawLine(centerX + 7, centerY, centerX + 14, centerY, SOLID, 0)
  lcd.drawLine(centerX + 7, centerY, centerX + 7, centerY + 4, SOLID, 0)
  -- right wing
  lcd.drawLine(centerX - 7, centerY, centerX - 14, centerY, SOLID, 0)
  lcd.drawLine(centerX - 7, centerY, centerX - 7, centerY + 4, SOLID, 0)
  -- cockpit center
